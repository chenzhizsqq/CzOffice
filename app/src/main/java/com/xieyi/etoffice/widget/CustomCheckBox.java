...
public class CustomCheckBox extends View {
    ...
    private void initAttr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int style;
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CustomCheckBox, defStyleAttr, 0);
            mCheckCircleColor = array.getColor(R.styleable.CustomCheckBox_hcb_check_circle_color, defaultCheckCircleColor);
            mUncheckCircleColor = array.getColor(R.styleable.CustomCheckBox_hcb_uncheck_circle_color, defaultUncheckCircleColor);
            mCheckHookColor = array.getColor(R.styleable.CustomCheckBox_hcb_check_hook_color, defaultCheckHookColor);
            mUncheckHookColor = array.getColor(R.styleable.CustomCheckBox_hcb_uncheck_hook_color, defaultUncheckHookColor);
            ...
            mLineWidth = array.getDimension(R.styleable.CustomCheckBox_hcb_line_width, defaultLineWidth);
            array.recycle();
        } else {
